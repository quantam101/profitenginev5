...
const ignoredFiles = new Set(['package-lock.json', 'security_scanner.py', 'verifier.py', 'health.mjs', 'first-boot.sh', 'docker-compose.yml']);
...
const ignoredPaths = new Set([
  ...
  'runtime/agent_impls/docker_guard.py',
  'tests/test_core.py',
  '.env.example',
  'CONTINUATION.md',
  'DEPLOYMENT.md',
