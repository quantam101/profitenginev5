...
// Full relative paths that legitimately reference secret-marker strings as env var names, not embedded values.
const ignoredPaths = new Set(['app/api/advisor/route.ts', 'app/dashboard/page.tsx']);
