  ...
  return (
    <footer className="relative z-10 border-t border-line bg-bg-surface py-12" data-testid="site-footer">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-4 md:px-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2 font-display text-lg">
            ...
            <span>PROFIT<span className="text-acid">ENGINE</span> <span className="text-ink-muted">v5</span></span>
          </div>
          ...
          <code className="mt-5 inline-block border border-line bg-bg px-3 py-2 text-xs">
            <span className="text-acid">$</span> git clone github.com/quantam101/profitenginev5
          </code>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs text-ink">
            <li><a href="#agents" className="transition-colors hover:text-acid">Agents</a></li>
            <li><Link to="/dashboard" className="transition-colors hover:text-acid">Dashboard</Link></li>
            <li><a href="#engine" className="transition-colors hover:text-acid">Self-merge engine</a></li>
            <li><a href="#pricing" className="transition-colors hover:text-acid">Pricing</a></li>
            <li><a href="#roadmap" className="transition-colors hover:text-acid">Roadmap</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs text-ink">
            ...
            <li><a href="#waitlist" className="transition-colors hover:text-acid">Beta waitlist</a></li>
            <li><a href="#faq" className="transition-colors hover:text-acid">FAQ</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="mx-auto mt-12 flex max-w-7xl items-center justify-between border-t border-line px-6 pt-6 text-[11px] text-ink-faint md:px-10">
        ...
        <span className="text-acid">v5.0 — closed beta</span>
      </div>
    </footer>
  );
}
