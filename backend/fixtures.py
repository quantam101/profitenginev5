...
AGENTS = [
    {"id": "sovereign-orchestrator", "name": "Prime Orchestrator", "type": "orchestrator", "tier": "sovereign",
     "status": "active", "category": "command",
     "mission": "Controls the full system, assigns work to parallel agents, resolves conflicts.",
    ...
    {"id": "lifelong-catch-correct", "name": "Failure Analysis Agent", "type": "learning", "tier": "learning",
     "status": "active", "category": "learning",
     "mission": "Diagnose failed objectives, generate fixes, and prevent repeated mistakes.",
     "last_run": "27m ago",
    ...
    # ── Enterprise expansion (Feb 2026) — 9 new MVP agents ──
    {"id": "motivation-engine", "name": "Motivation Engine Agent", "type": "learning", "tier": "learning",
     "status": "active", "category": "learning",
     "mission": "Convert missed targets into higher learning velocity and execution pressure.",
     "last_run": "8m ago",
     "run_count": 89, "success_rate": 0.96, "success_count": 85, "failure_count": 4, "recent_fails": 1, "runs_today": 8,
     "cycle_interval_min": 90, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "revenue-intelligence", "name": "Revenue Intelligence Agent", "type": "revenue", "tier": "revenue",
     "status": "active", "category": "revenue",
     "mission": "Identify the highest-probability path to collected cash.",
     "last_run": "4m ago",
     "run_count": 211, "success_rate": 0.93, "success_count": 196, "failure_count": 15, "recent_fails": 4, "runs_today": 14,
     "cycle_interval_min": 30, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "offer-engineering", "name": "Offer Engineering Agent", "type": "revenue", "tier": "revenue",
     "status": "active", "category": "revenue",
     "mission": "Create and improve sellable offers, pricing tiers, and conversion mechanics.",
     "last_run": "19m ago",
     "run_count": 73, "success_rate": 0.95, "success_count": 69, "failure_count": 4, "recent_fails": 1, "runs_today": 5,
     "cycle_interval_min": 180, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "sales-execution", "name": "Sales Execution Agent", "type": "revenue", "tier": "revenue",
     "status": "active", "category": "revenue",
     "mission": "Generate outreach, follow-ups, scripts, and pipeline conversations.",
     "last_run": "3m ago",
     "run_count": 304, "success_rate": 0.92, "success_count": 280, "failure_count": 24, "recent_fails": 6, "runs_today": 19,
     "cycle_interval_min": 30, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "cash-conversion", "name": "Cash Conversion Agent", "type": "revenue", "tier": "revenue",
     "status": "active", "category": "revenue",
     "mission": "Convert pipeline to collected cash; focus on invoices, follow-ups, recoveries.",
     "last_run": "21m ago",
     "run_count": 188, "success_rate": 0.91, "success_count": 171, "failure_count": 17, "recent_fails": 5, "runs_today": 11,
     "cycle_interval_min": 60, "model": "openai/gpt-5.2"},
    {"id": "learning-agent", "name": "Learning Agent", "type": "learning", "tier": "learning",
     "status": "active", "category": "learning",
     "mission": "Close skill and strategy gaps; convert lessons into deployed improvements.",
     "last_run": "33m ago",
     "run_count": 67, "success_rate": 0.97, "success_count": 65, "failure_count": 2, "recent_fails": 1, "runs_today": 5,
     "cycle_interval_min": 120, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "analytics-agent", "name": "Analytics Agent", "type": "analytics", "tier": "command",
     "status": "active", "category": "command",
     "mission": "Measure revenue, activity, conversion, and per-agent performance signals.",
     "last_run": "1m ago",
     "run_count": 1206, "success_rate": 0.99, "success_count": 1194, "failure_count": 12, "recent_fails": 2, "runs_today": 162,
     "cycle_interval_min": 5, "model": "gemini/gemini-2.0-flash"},
    {"id": "codex-optimization", "name": "Codex Optimization Agent", "type": "product", "tier": "product",
     "status": "active", "category": "product",
     "mission": "Review and improve code, patch regressions, log changes to Codex changelog.",
     "last_run": "52m ago",
     "run_count": 142, "success_rate": 0.96, "success_count": 136, "failure_count": 6, "recent_fails": 2, "runs_today": 4,
     "cycle_interval_min": 240, "model": "anthropic/claude-sonnet-4-5"},
    {"id": "audit-agent", "name": "Audit Agent", "type": "governance", "tier": "command",
     "status": "active", "category": "command",
     "mission": "Log every decision, action, approval, and failure for compliance and replay.",
     "last_run": "14s ago",
     "run_count": 5402, "success_rate": 1.0, "success_count": 5402, "failure_count": 0, "recent_fails": 0, "runs_today": 740,
     "cycle_interval_min": 1, "model": "openai/gpt-5.2"},
]
